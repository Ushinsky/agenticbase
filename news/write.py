...
2. Пишет для отобранных анонс — одно-два предложения, по которым читатель
   решает, открывать или нет. Это единственное место конвейера, где работает
   Opus, и материалов здесь пара десятков, а не сотни. Выводы, ожидаемый
   результат и ограничения писались до 2026-09-09 и больше не пишутся: на
   карточке их нет, а платить за невидимый текст незачем.
...
Больше ничего писать не нужно. Ни выводов, ни ожидаемого результата, ни ограничений: на карточке стоит только анонс, а платить самой дорогой модели за текст, которого никто не увидит, незачем.
